...
- **24 apps** via winget (PowerShell 7, Git, TortoiseGit, GitHub CLI, GitHub Copilot CLI, VS Code, .NET SDK 10, Python 3.14, UV, Node.js LTS, Docker Desktop, ABP Studio, NVM for Windows, Coreutils for Windows, ripgrep, fd, jq, bat, fzf, git-delta, WireGuard, Windows Application CLI, plus optional Oh My Posh and PowerToys).
